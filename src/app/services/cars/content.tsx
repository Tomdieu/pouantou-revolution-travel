...
import { Car, ArrowRight, Check, Clock, Globe, Shield, Phone, ArrowLeft } from 'lucide-react';
...
export default function CarsPageContent() {
    ...
    return (
        <div className="bg-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <p className="text-lg text-slate-500 leading-relaxed mb-8">
                            ...
                            Assurance complète incluse, récupération et retour faciles.
                        </p>
                        <Button
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    'Assurance complète incluse dans le tarif',
                                    'Récupération et retour flexibles',
                                    'GPS et sièges bébé disponibles sur demande',
                                ...
                                {[
                                    {
                                        ...
                                        text: 'Indiquez les dates, lieux de prise en charge et type de véhicule souhaité.',
                                    },
                                    {
                                        step: '2',
                                        title: 'Recevez les offres',
                                        text: 'Comparez les propositions de nos partenaires de location.',
                                    },
                                    {
                                        step: '3',
                                        title: 'Roulez en liberté',
                                        text: 'Récupérez votre véhicule et profitez de votre trajet, assurance incluse.',
                                    },
                                ].map((item) => (
            ...
            <section className="py-16 bg-slate-50 border-y border-slate-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { icon: Car, value: '500+', label: 'Véhicules disponibles' },
                            { icon: Globe, value: '50+', label: 'Villes couvertes' },
                            { icon: Clock, value: '24/7', label: 'Assistance routière' },
                            { icon: Shield, value: '100%', label: 'Assurance incluse' },
                        ].map((stat) => (
            ...
            <section className="py-20 bg-slate-950">
                <div className="max-w-3xl mx-auto text-center px-4">
                    ...
                    <p className="text-lg text-slate-400 mb-8">
                        Lancez votre recherche ou contactez un expert pour un devis rapide.
                    </p>
            ...
            <CarRentalDialog isOpen={searchOpen} onOpenChange={setSearchOpen} />
        </div>
    );
}
