...
import { Loader2, Mail, Lock, Plane, Eye, EyeOff } from 'lucide-react';
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <div className="flex items-center justify-between ml-1">
                                                    <FormLabel className="text-xs font-bold text-gray-500 uppercase tracking-wider">Mot de passe</FormLabel>
                                                    <Link
